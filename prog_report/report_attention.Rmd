...
param.base<-list(totRounds=10000,ResReward=1,VisReward=1,
            ...
            propfullPrint = 0.7,
            alphaT=0.005,printGen=1,seed=1, gammaRange=I(c(0)),
...
# 
Param<-"attenMech"
rangParam<-c(0,1,2,3,4)
labAtt<-c("Rescola-Wagner","Mackintosh","Pearce-Hall","Mackintosh2","Pearce-Hall2")
# 
...
list_files<-list.files(here("Simulations",scenario),full.names = TRUE) %>%
  grep(pattern = "PIA",value = TRUE) %>% grep(pattern = "alph0.005",value = TRUE)
...
rawData[,AttMech:=factor(AttMech,levels = c(0,1,2,3,4),
                      labels = labAtt)]
...
PAAtimeInt[,AttMech:=factor(AttMech,levels = c(0,1,2,3,4),
                            labels = labAtt)]
